  ...
  return (
    <div className="component__roadmap">
      <div className="roadmap-body">
        <div className="bg-white h-20 lg:w-52 2xl:w-80 w-40 rounded-tl-[50px] rounded-bl-[50px] relative flex items-center">
          ...
          <div className="translate-x-12 text-center">
            <h1 className="text-[18px] lg: font-semibold uppercase">
              {props.month}
            </h1>
